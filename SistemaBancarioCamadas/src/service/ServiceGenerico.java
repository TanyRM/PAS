...
public class ServiceGenerico {
    private GenericDAO<Cliente> clienteDAO = new GenericDAO<>(Cliente.class);
    private GenericDAO<Conta> contaDAO = new GenericDAO<>(Conta.class);
    ...
    public Cliente criarCliente(String nome, String cpf, String email) {
        ...
        List<Cliente> clientesComCpf = clienteDAO.buscarPorCampo("cpf", cpf);
        if(!clientesComCpf.isEmpty()) {
